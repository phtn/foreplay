...
export function TonesCategory<Key extends string>({
  config,
  description,
  events,
  id,
            ...
            <Card key={key} size='sm' className='ring-border bg-card rounded-md p-0'>
              <CardContent className='flex flex-col gap-4 p-0'>
                <div className='flex items-center justify-between'>
                  ...
                  <div className='flex items-center space-x-4'>
                    ...
                    <Icon
                      ...
                      className={cn('size-6', {
                        'opacity-50 pointer-events-none': !isEnabled || !draft.enabled || testingKey !== null
                      })}
                    />
                  </div>
                  <Icon name='save' className='size-4 opacity-80' />
                </div>
                ...
                <Button
                  ...
                  className='rounded-sm font-clash hidden'>
