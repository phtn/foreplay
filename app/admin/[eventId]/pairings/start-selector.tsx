          ...
          <div className='grid grid-cols-3 gap-1 p-2'>
            {startingHoles.map((hole) => (
              <Button
                ...
                size='icon'
                className={cn(
                  'flex h-12 w-12 aspect-square items-center justify-center rounded-lg font-poly text-sm font-semibold tabular-nums transition-colors duration-200',
                  value === hole
                    ? 'bg-primary/60 dark:bg-primary/50 dark:text-white text-primary-foreground'
                    : 'bg-slate-100 dark:bg-slate-400/5 hover:bg-primary hover:text-white dark:hover:bg-primary'
                )}
