export const icons = {
  ...
  mail: {
    symbol:
      '<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><rect width="18.5" height="15.5" x="2.75" y="4.25" rx="3"/><path d="m2.75 8l8.415 3.866a2 2 0 0 0 1.67 0L21.25 8"/></g>',
    viewBox: '0 0 24 24',
    set: 'proicons'
  },
  lock: {
  ...
  watch: {
    symbol:
      '<g fill="#000" clip-path="url(#a)"><path d="M11.636 3.241 10.51 5.625h11.034L20.37 3.241zM11.21 28.5 11 27h10l-.333 1.5z" fill="currentColor"/><path fill-rule="evenodd" d="M11.21 7.333h9.457L25 12.5v7l-4.334 5.167H11.21L7 19.5v-7zM15 11.5V17l3.5 3 1-1-3.274-2.617V11.5z" clip-rule="evenodd" fill="currentColor"/></g><defs><clipPath><path fill="currentColor" d="M0 0h32v32H0z"/></clipPath></defs>',
    viewBox: '0 0 32 32',
    set: 'svg'
  },
  'map-pin': {
    symbol:
      '<path fill="currentColor" d="M15.213 26.851a2.05 2.05 0 0 1-.704-.446 45 45 0 0 1-3.234-3.481q-1.406-1.696-2.348-3.288-.942-1.59-1.434-3.064Q7 15.099 7 13.759q0-4.462 2.715-7.11T16 4q3.57 0 6.287 2.648T25 13.76q0 1.339-.492 2.813-.49 1.474-1.434 3.064-.943 1.592-2.349 3.288a45 45 0 0 1-3.234 3.48 2.05 2.05 0 0 1-.703.447q-.395.15-.788.149-.394 0-.787-.149m2.377-11.648q.66-.7.66-1.682a2.36 2.36 0 0 0-.66-1.68q-.66-.7-1.59-.7-.93-.001-1.588.7a2.38 2.38 0 0 0-.662 1.68 2.35 2.35 0 0 0 .662 1.682q.663.702 1.588.699.924-.005 1.59-.699"/>',
    viewBox: '0 0 32 32',
    set: 'svg'
  },
  'chevron-right': {
  ...
  calendar: {
    symbol:
      '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.25 4.75H6.75a3.5 3.5 0 0 0-3.5 3.5v9.5a3.5 3.5 0 0 0 3.5 3.5h10.5a3.5 3.5 0 0 0 3.5-3.5v-9.5a3.5 3.5 0 0 0-3.5-3.5m-14 4.5h17.5M7.361 4.75v-2m9.25 2v-2"/>',
    viewBox: '0 0 24 24',
    set: 'proicons'
  },
  'tag-arrow': {
  ...
  cash: {
    symbol:
      '<g fill="none" fill-rule="evenodd"><path d="m12.594 23.258l-.012.002l-.071.035l-.02.004l-.014-.004l-.071-.036q-.016-.004-.024.006l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.016-.018m.264-.113l-.014.002l-.184.093l-.01.01l-.003.011l.018.43l.005.012l.008.008l.201.092q.019.005.029-.008l.004-.014l-.034-.614q-.005-.019-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.003-.011l.018-.43l-.003-.012l-.01-.01z"/><path fill="currentColor" d="M20 5a2 2 0 0 1 1.995 1.85L22 7v10a2 2 0 0 1-1.85 1.995L20 19H4a2 2 0 0 1-1.995-1.85L2 17V7a2 2 0 0 1 1.85-1.995L4 5zm-2.997 2H6.997L7 7.125A2.875 2.875 0 0 1 4.125 10L4 9.997v4.006L4.125 14A2.875 2.875 0 0 1 7 16.875L6.997 17h10.006L17 16.875a2.875 2.875 0 0 1 2.706-2.87l.232-.004l.062.002V9.997l-.125.003a2.875 2.875 0 0 1-2.87-2.706L17 7.062zm2.872 9a.875.875 0 0 0-.866 1H20v-.991a1 1 0 0 0-.125-.009m-15.75 0a1 1 0 0 0-.125.009V17h.991a.875.875 0 0 0-.866-1M12 8a4 4 0 1 1 0 8a4 4 0 0 1 0-8m0 2a2 2 0 1 0 0 4a2 2 0 0 0 0-4M4.991 7H4v.991a.875.875 0 0 0 1-.866l-.002-.063zM20 7h-.991a.875.875 0 0 0 .866 1l.063-.002L20 7.99z"/></g>',
    viewBox: '0 0 24 24',
    set: 'mingcute'
  },
  search: {
  ...
  'camera-off-line': {
    symbol:
      '<g fill="none" fill-rule="evenodd"><path d="m12.594 23.258l-.012.002l-.071.035l-.02.004l-.014-.004l-.071-.036q-.016-.004-.024.006l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.016-.018m.264-.113l-.014.002l-.184.093l-.01.01l-.003.011l.018.43l.005.012l.008.008l.201.092q.019.005.029-.008l.004-.014l-.034-.614q-.005-.019-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.003-.011l.018-.43l-.003-.012l-.01-.01z"/><path fill="currentColor" d="M2.515 2.515a1 1 0 0 1 1.32-.084l.094.084L6.415 5h.17L8 3.586a2 2 0 0 1 1.238-.578L9.414 3h5.172a2 2 0 0 1 1.284.467l.13.119L17.414 5H20a2 2 0 0 1 1.995 1.85L22 7v12a2 2 0 0 1-.294 1.045l-.1.147l.381.38a1 1 0 0 1-1.32 1.498l-.094-.083L2.515 3.93a1 1 0 0 1 0-1.414m-.408 3.838L4 8.247V19h10.754l2 2H4a2 2 0 0 1-2-2V7q.002-.34.107-.647M14.586 5H9.414L8 6.414l-.088.083L9.553 8.14a5 5 0 0 1 6.808 6.808L20 18.586V7h-2.586A2 2 0 0 1 16 6.414zm-7.459 6.374l2.003 2.003a3 3 0 0 0 1.993 1.993l2.003 2.003a5 5 0 0 1-5.999-5.999M12 9.5c-.327 0-.642.052-.936.15l3.787 3.787A3 3 0 0 0 12 9.5"/></g>',
    viewBox: '0 0 24 24',
    set: 'mingcute'
  },
  'compass-fill': {
  ...
  'undo-variant': {
    symbol:
      '<path fill="currentColor" d="M13.5 7a6.5 6.5 0 0 1 6.5 6.5a6.5 6.5 0 0 1-6.5 6.5H10v-2h3.5c2.5 0 4.5-2 4.5-4.5S16 9 13.5 9H7.83l3.08 3.09L9.5 13.5L4 8l5.5-5.5l1.42 1.41L7.83 7zM6 18h2v2H6z"/>',
    viewBox: '0 0 24 24',
    set: 'mdi'
  },
  columns: {
  ...
  service: {
    symbol:
      '<g fill="none" fill-rule="evenodd"><path d="m12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.018-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z"/><path fill="currentColor" d="M5 9a7 7 0 0 1 14 0v1.035c1.696.243 3 1.702 3 3.465v.25a3.25 3.25 0 0 1-3.332 3.248c-.74 2.12-2.622 3.549-4.653 3.911c-.47.172-1.026.091-1.515.091a1.5 1.5 0 0 1 0-3h1a1.5 1.5 0 0 1 1.207.609C16.003 17.992 17 16.689 17 15V9A5 5 0 0 0 7 9v6.25A1.75 1.75 0 0 1 5.25 17A3.25 3.25 0 0 1 2 13.75v-.25a3.5 3.5 0 0 1 3-3.465zm0 3.085A1.5 1.5 0 0 0 4 13.5v.25c0 .605.43 1.11 1 1.225zm14 0v2.89c.57-.116 1-.62 1-1.225v-.25a1.5 1.5 0 0 0-1-1.415"/></g>',
    viewBox: '0 0 24 24',
    set: 'mingcute'
  },
  'heart-hand': {
  ...
  receipt: {
    symbol:
      '<path fill="currentColor" fill-rule="evenodd" d="M62.4 66.8A1 1 0 0 0 64 66V14a1 1 0 0 0-1.6-.8l-5.8 4.35a1 1 0 0 1-1.2 0l-6.8-5.1a1 1 0 0 0-1.2 0l-6.8 5.1a1 1 0 0 1-1.2 0l-6.8-5.1a1 1 0 0 0-1.2 0l-6.8 5.1a1 1 0 0 1-1.2 0l-5.8-4.35a1 1 0 0 0-1.6.8v52a1 1 0 0 0 1.6.8l5.8-4.35a1 1 0 0 1 1.2 0l6.8 5.1a1 1 0 0 0 1.2 0l6.8-5.1a1 1 0 0 1 1.2 0l6.8 5.1a1 1 0 0 0 1.2 0l6.8-5.1a1 1 0 0 1 1.2 0zM27 24.5a3 3 0 1 0 0 6h26a3 3 0 1 0 0-6zm-3 15a3 3 0 0 1 3-3h26a3 3 0 1 1 0 6H27a3 3 0 0 1-3-3m3 9a3 3 0 1 0 0 6h26a3 3 0 1 0 0-6z" clip-rule="evenodd"/>',
    viewBox: '0 0 80 80',
    set: 'glyphs'
  },
  save: {
  ...
  'align-right': {
    symbol:
      '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M4 4h16M10 9h10M4 14h16m-10 5h10"/>',
    viewBox: '0 0 24 24',
    set: 'mingcute'
  },
  goldticket: {
    symbol:
      '<path fill="currentColor" d="M1.875.5h12.25c.957 0 1.75.793 1.75 1.75V4c0 .246-.219.438-.437.52-.52.19-.876.656-.876 1.23s.356 1.066.876 1.258c.218.082.437.273.437.492v1.75c0 .984-.793 1.75-1.75 1.75H1.875c-.984 0-1.75-.766-1.75-1.75V7.5c0-.219.191-.41.41-.492.52-.192.903-.684.903-1.258S1.055 4.71.535 4.52C.316 4.438.125 4.246.125 4V2.25C.125 1.293.891.5 1.875.5m1.75 3.063a.45.45 0 0 1 .438-.438h7.875a.47.47 0 0 1 .437.438v4.374a.45.45 0 0 1-.437.438H4.061a.43.43 0 0 1-.437-.437zm-.875-.438v5.25c0 .492.383.875.875.875h8.75a.88.88 0 0 0 .875-.875v-5.25a.9.9 0 0 0-.875-.875h-8.75a.88.88 0 0 0-.875.875"/>',
    viewBox: '0 0 16 11',
    set: 'svg'
  },
  'e-mail': {
  ...
  print: {
    symbol:
      '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 18h3a1 1 0 0 0 1-1v-7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v7a1 1 0 0 0 1 1h3m8-7h2M7 4h10v4H7zm0 11h10v6H7z"/>',
    viewBox: '0 0 24 24',
    set: 'mingcute'
  },
  'home-fill': {
