...
export function ReUITable() {
  return (
    <div className='mx-auto flex w-full max-w-7xl flex-col'>
      <div className='font-okx text-xl py-3'>Pairings Sheet</div>
      <Table>
        <TableHeader>
          <TableRow>
        ...
        <TableBody>
          {leaders.map((leader) => (
            <TableRow key={leader.rank} className='divide-y divide-slate-300'>
              <TableCell className='text-center text-sm font-bold'>{leader.rank}</TableCell>
              <TableCell>
                <div className='flex items-center gap-3'>
                  ...
                  <div className='flex flex-col'>
                    ...
                    <span className='text-muted-foreground text-xs'>{leader.handle}</span>
                  </div>
                </div>
              </TableCell>
              <TableCell>
